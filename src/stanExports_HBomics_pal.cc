...
#include "stanExports_HBomics_pal.h"

RCPP_MODULE(stan_fit4HBomics_pal_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_HBomics_pal")
